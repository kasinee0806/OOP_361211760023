...
public class ExArray2D {
    //Array 2 มิติ คือตัวแปรที่เก็บข้อมูลในลักษณะของ แถวแนวนอน (row) และแถวแนนตั้ง (column)
    ...
    int total = 0;
        ...
        for (int i = 0; i < x.length; i++) { // วนลูปแถวแนวนอน
            for (int j = 0; j < x[i].length; j++) { //วนลูปแถวแนวตั้ง
                ...
                total += x[i][j];  // นำข้อมูลทุกบล็อคมาบวกรวมกันแล้วเก็บไว้ใน total
            }//j
            System.out.println();
        }//i
